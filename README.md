I created a base file, all you guys have to do is install jdk26 from adoptium and maven from maven.apache.org (Highlight the links below and click the "Go to..." option) 
